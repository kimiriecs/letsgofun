  ...
  <div class="col-md-4 mb-2">
    <div class="card">
      ...
      <div class="card-footer d-flex justify-content-end">
        <button type="submit" class="btn btn-outline-success ml-3" @click.prevent="getSingleOrderAction( { orderId: order.id, routeName: 'dashOrderShow' } )">
          Full Information
        <!-- <router-link :to="{ name: 'showOrder', params: { id: order.id, singleOrder: singleOrder } }">Edit</router-link> -->
        </button>
        <button type="submit" class="btn btn-outline-info ml-3" @click.prevent="getSingleOrderAction( { orderId: order.id, routeName: 'dashOrderEdit' } )">
          Edit
